...
namespace DummyMicroservice
{
    public class MemoryHealthCheck : IHealthCheck
    {
        ...
        {
            { "AllocatedMegaBytes", ConvertBytesToMegabytes(allocated) },
            ...
            return Task.FromResult(new HealthCheckResult(
                status,
                description: "Reports degraded status if allocated Megabytes " +
                    $">= {ConvertBytesToMegabytes(options.Threshold)} Megabytes.",
                exception: null,
                data: data));
        }
